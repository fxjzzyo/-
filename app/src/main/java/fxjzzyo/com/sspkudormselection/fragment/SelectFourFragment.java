 ...
 * Use the {@link SelectFourFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class SelectFourFragment extends Fragment  implements SwipeRefreshLayout.OnRefreshListener{
    ...
    EditText etVcode2;
    @BindView(R.id.et_stduid3)
    EditText etStduid3;
    @BindView(R.id.et_vcode3)
    EditText etVcode3;
     ...
     * @return A new instance of fragment SelectFourFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static SelectFourFragment newInstance(String param1, String param2) {
        SelectFourFragment fragment = new SelectFourFragment();
    ...
    private void btnPostSelect() {
        ...
        //获取同住人3信息
        String studid3 = etStduid3.getText().toString().trim();
        String vcode3 = etVcode3.getText().toString().trim();

        if (studid3.isEmpty() || vcode3.isEmpty()) {
            Toast.makeText(getActivity(),"请完善同住人信息！",Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private SelectFourFragment.DialogOnClick dialogOnClick = new SelectFourFragment.DialogOnClick();
